...
var RootCmd = &cobra.Command{
	Use:   "goji",
	Short: "Goji is a set of tools to accelerate GO development",
	Long: `Goji is in early development stage.
...
func initConfig() {
	...
	viper.SetConfigName(".goji") // name of config file (without extension)
